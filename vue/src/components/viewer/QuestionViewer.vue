  ...
  <fieldset class="mb-4">
    ...
    <div class="mt-3">
        <div v-if="question.type === 'select'">
            <select
            :value="modelValue"
            class="mt-1 block w-1/5 py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
